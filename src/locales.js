...
export const LOCALE_STORAGE_KEY = "violeta-portfolio-locale";
...
export const locales = {
  es: {
    meta: {
      code: "es",
      label: "Spain",
      switchTriggerLabel: "Seleccionar idioma",
      switchMenuLabel: "Selector de idioma",
      currentLanguagePrefix: "Idioma actual",
    },
    document: {
      home: "Violeta Guinea · Portfolio CV",
      about: "Violeta Guinea · Sobre mí",
      skills: "Violeta Guinea · Skills",
      education: "Violeta Guinea · Formación",
      experience: "Violeta Guinea · Experiencia",
      contact: "Violeta Guinea · Contacto",
    },
    cover: {
      top: "PORTFOLIO CV",
    ...
    common: {
      headerTitle: "PERFIL · PORTFOLIO CV",
  ...
  en: {
    meta: {
      code: "en",
      label: "English",
      switchTriggerLabel: "Select language",
      switchMenuLabel: "Language selector",
      currentLanguagePrefix: "Current language",
    },
    document: {
      home: "Violeta Guinea · Portfolio CV",
      about: "Violeta Guinea · About me",
      skills: "Violeta Guinea · Skills",
      education: "Violeta Guinea · Education",
      experience: "Violeta Guinea · Experience",
      contact: "Violeta Guinea · Contact",
    },
    cover: {
      top: "PORTFOLIO CV",
    ...
    common: {
      headerTitle: "PROFILE · PORTFOLIO CV",
...
export function getLocaleMeta(locale = currentLocale) {
  return locales[locale]?.meta || locales[DEFAULT_LOCALE].meta;
}

export function getLocaleSwitchOptions() {
  return Object.values(locales).map(({ meta }) => ({
    locale: meta.code,
    label: meta.label,
  }));
}

export function getLocaleValue(key, locale = currentLocale) {
  return key.split(".").reduce((value, part) => value?.[part], locales[locale]);
}
